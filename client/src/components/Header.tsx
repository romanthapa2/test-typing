...
import { setTheme } from "../store/preferenceSlice";
import { setTime, setType } from "../store/preferenceSlice";
import { setWordList } from "../store/wordSlice";
import { timerSet } from "../store/timeSlice";
import { RootState, AppDispatch } from "../store/store";
import "../styleSheets/header.css";
import "../styleSheets/animatedTheme.css";
...
export default function Header() {
  const { timeLimit, theme, type } = useSelector(
    (state: RootState) => state.preferences
  );
  const [animationProps, setAnimationProps] = useState<AnimationProps | null>();
  const timerId = useSelector((state: RootState) => state.time.timerId);
